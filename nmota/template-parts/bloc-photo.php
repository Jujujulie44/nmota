<?php
//recupere l'ID de l'image avec wp
...
<div class="blockPhotoRelative">
    ...
    <div class="overlay">
        ...
        <?php if ($reference) : ?>
            <div class="fullscreen-icon" data-full="<?php echo esc_attr($photoID); ?>" data-category="<?php echo esc_attr($categorie_name); ?>" data-reference="<?php echo esc_attr($reference); ?>">
